...
├── domain/
│   ├── rate-limiter.js      # Janela deslizante, rastreio de disparos, cooldown
...
├── infrastructure/
│   ├── database/
│   │   ├── connection.js    # SQLite (better-sqlite3) com WAL + migrações
│   │   ├── snowflake.js     # Gerador de IDs BigInt de 64 bits
│   │   ├── requests-repository.js  # CRUD de requisições + agregações
│   │   ├── throttle-repository.js  # Singleton de estado + log de eventos
